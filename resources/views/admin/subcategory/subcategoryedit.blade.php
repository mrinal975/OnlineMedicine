            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="well">
                        ...
                        <br>
                        {!! Form::open(['url'=>'adminpanel/sub-category/update','method'=>'POST','class'=>'form-horizontal']) !!}
                            ...
                            <div class="col-sm-8 {{ $errors->has('name') ? ' has-error' : '' }}">
                                <select class="form-control" name="categoryId">
                                    @foreach($category as $cat)
                                        <option value="{{$cat->id}}" @if ($subcategoryById->id==$cat->id) selected @endif>{{$cat->categoryName}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8 {{ $errors->has('name') ? ' has-error' : '' }}">
                                <input type="text" class="form-control" name="subcategoryName" value="{{$subcategoryById->subcategoryName}}">
                                <input type="hidden" class="form-control" name="subcategoryId" value="{{$subcategoryById->id}}">
                        ...
                        <div class="form-group {{ $errors->has('subcategoryDescriptoin') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="subcategoryDescriptoin" rows="8">{{$subcategoryById->subcategoryDescriptoin}}</textarea>
