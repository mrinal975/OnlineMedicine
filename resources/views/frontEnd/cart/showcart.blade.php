            ...
            <div class="row">
                <div class="table-responsive table-striped">
                    <table class="table table-hover ">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Item Total Price</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php $total=0?>
                        @foreach($cartProduct as $cartProduct)
                            <tr class="rem1">
                                ...
                                <td class="text-center invert">{{$cartProduct->name}}</td>
                                ...
                                <td class="invert text-center">TK:{{$cartProduct->price}}</td>
                                <td class="invert text-center">TK.{{$itemTotal=$cartProduct->price*$cartProduct->qty}}</td>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-3"><h2> <strong>Total Price: <span class="text-info"><?php echo $total;?> .TK</span></strong> </h2></div>
                    </div>
                </div>
